          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-8">
            ...
            >
              <Card className="bg-white border-gray-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 h-full flex flex-col">
                ...
                <Button className="w-full bg-[#c6ebcd] hover:bg-[#b5e1bb] text-white font-montserrat font-semibold py-3 px-4 rounded-full transition-all duration-200 hover:scale-105 mt-auto">
                  Order Filters
                </Button>
              </Card>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-center">
                  <Button
                    className="bg-[#b8d2f5] hover:bg-[#a5c4f0] text-[#36454F] px-8 py-3 rounded-full font-montserrat font-semibold transition-all duration-200 hover:scale-105"
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <Button className="bg-[#c6ebcd] hover:bg-[#b5e1bb] text-white px-8 py-3 rounded-full text-lg font-montserrat font-semibold transition-all duration-200 hover:scale-105">
              Visit Help Center
            </Button>
          </motion.div>
        </div>

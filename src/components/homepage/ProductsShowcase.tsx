...
export function ProductsShowcase() {
  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20 md:pb-24 bg-white relative">
      ...
      {/* Gradient Transition to Slate - positioned lower to avoid cutting off buttons */}
      <div className="absolute -bottom-2 left-0 right-0 h-16 bg-gradient-to-b from-white to-slate-50 pointer-events-none z-10"></div>
    </section>
  )
}
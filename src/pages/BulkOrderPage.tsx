        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-2xl font-sora font-bold text-[#36454F] mb-2">
              ...
              <Button
                ...
                className="bg-brand-pastel-green hover:bg-brand-pastel-green/90 text-white px-6 py-2 rounded-full font-sora"
              >
                Close
              </Button>
            </div>
      ...
      <section className="relative bg-white pt-32 pb-8 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <motion.h1 
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-sora font-bold leading-tight mb-4 text-[#36454F]"
          >
          ...
          >
            Get customized pricing and priority support for your organization.
          </motion.p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              ...
              >
                <Card className="bg-white border-0 rounded-3xl p-6 lg:p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 border border-gray-100/50 backdrop-blur-sm"
                  ...
                  <div className="mb-6">
                    <h2 className="text-2xl lg:text-3xl font-sora font-bold text-[#36454F] mb-2">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-lg font-sora font-semibold text-[#36454F]">
                          Contact Information
                        </h3>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center mb-2">
                        ...
                        <Label htmlFor="notes" className="text-lg font-sora font-semibold text-[#36454F]">
                    ...
                    <div className="pt-3">
                      <Button
                        ...
                        className="w-full bg-green-800 hover:bg-green-900 text-white py-3 px-6 rounded-full font-sora font-semibold text-base transition-all duration-200 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed h-12"
                      >
                        {isSubmitting ? (
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-2xl font-sora font-bold text-[#36454F] mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-sora font-semibold text-[#36454F] mb-2">Volume Discounts</h4>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-sora font-semibold text-[#36454F] mb-2">Priority Support</h4>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-sora font-semibold text-[#36454F] mb-2">Custom Solutions</h4>
                ...
                >
                  ...
                  <h4 className="text-lg font-sora font-semibold text-[#36454F] mb-4">Need Help?</h4>
